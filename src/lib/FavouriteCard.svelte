...
>
	<div class="w-1/3 whitespace-nowrap overflow-hidden text-ellipsis">{word.match}
		<span class="font-light">({word.pronunciation})</span>
	</div>

	<div class="w-2/3 whitespace-nowrap overflow-hidden text-ellipsis">{word.definitions}</div>
